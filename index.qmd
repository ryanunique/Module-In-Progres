...
![Shapefile has the same name but a different file extension.](Pictures/Shapefile.png){alt="Shapefile has the same name but a different file extension." width="577"}
