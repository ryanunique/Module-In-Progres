...
**Step 4.** Export the Municipality.shp and transform its CRS into `EPSG: 32651- UTM51N`. To do this Rigth Click the ![](images/clipboard-464955719.png) in the layers panel and in the menu select `Export` .
